...
merged_df = pd.merge(df, df_tr, how='inner', left_on="url", right_on="url")
...
print_dict = {}
corr_list = ["views", "comments", "speaker_id", "languages", "wc", "wpm", "duration", "comments_views", "views_comments"]

print_dict["/"] = corr_list
for c in corr_list:
    temp_dict = get_rating_correlations(merged_df, c, 0.0)
